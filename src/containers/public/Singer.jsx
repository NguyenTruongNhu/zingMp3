    ...
    return (
        <div className="flex flex-col w-full">
            <div ref={ref} className="relative">
                <img src={artistData?.thumbnailM} alt="background" className="h-[300px] object-cover w-full" />
                <div className="absolute top-0 left-0 right-0 text-white  bottom-0 bg-gradient-to-t from-[rgba(0,0,0,0.5)] to-transparent px-[59px]">
                    <div className="absolute bottom-0 pb-6">
                        <div className="flex gap-8 items-center">
                            ...
                            >
                                ...
                                {isHoverPlay && (
                                    <span className="absolute animate-scale-up-center top-[-1px] left-[-1px] right-[-1px] bottom-[-1px] bg-main-500 rounded-full"></span>
                                )}
                        ...
                        <div className="flex items-center gap-4 mt-4">
                            ...
                            <button
                                className=" bg-main-500 px-4 py-1 text-white text-sm rounded-l-full rounded-r-full flex justify-center items-center gap-1  "
                                type="button"
                            >
                                <span>
                                    <AiOutlineUserAdd />
            ...
            <div className="mt-[30px] px-[59px]  w-full flex">
            ...
            <div className="px-[59px] mt-12">
                ...
                <div className="flex gap-8">
                    <img
                        ...
                        alt="thumbnailM"
                        className="w-[45%] flex-none h-[375px] object-cover rounded-md"
                    />
