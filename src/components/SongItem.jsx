...
const SongItem = ({ thumbnail, title, artists, sid, releaseDate, order, style, percent, size }) => {
    ...
    return (
        <div
            ...
            className={`w-full flex-auto flex  p-[10px] gap-[10px] justify-between items-center  rounded-md cursor-pointer  ${
