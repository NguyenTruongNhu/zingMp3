    ...
    return (
        <div className="w-full overflow-hidden px-[59px] relative">
            <Button
                ...
                style="absolute top-1/2 left-[70px] bg-[rgba(255,255,255,0.3)] z-50 text-white p-1 rounded-full"
            />
            <Button
                handleOnclick={() => handleBack(-1)}
                icon={<MdArrowForwardIos size={30} />}
                style="absolute top-1/2 right-[70px] bg-[rgba(255,255,255,0.3)] z-50 text-white p-1 rounded-full"
            />
            <div onMouseLeave={(e) => setIsAuto(true)} className="flex gap-8 w-full  pt-8 ">
